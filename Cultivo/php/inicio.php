...
<body>
    <header class="header">
        <div class="menu container">
            ...
            <nav class="navbar"> 
                <ul>
                    <li><a href="#">Registrar  proyecciones</a></li>
                    <li><a href="#">Registrar  producciones</a></li>
    ...
    <section class="general container">
        <h2>Módulo web para la proyección y producción del cultivo de banano</h2>
        <p>Este módulo web constara de registros los cuales serán ingresados por los cultivadores, dichos registros son la proyección que hace enfasís en lo que dicho cultivador espera consefuir en su cultivo de banono y a su vez registrara los datos de producción con los cuales se realizara una breve compración para mostrar la diferencia entre lo obtenido (Producción) y lo esperado (Proyección).</p>
        <p>A continuación se dara una pequeña introducción sobre los terminos a utilizar.</p>
        <div class="general-content">
            <div class="general-1 txt">
                <h3>Proyección</h3>
                <p><span class="enfasís">La proyección de cultivos de banano se refiere al proceso de planificar y estimar la producción 
            ...
            <div class="general-2 txt">
                <h3>Producción</h3>
                <p><span class="enfasís">La producción de cultivos de banano se refiere al proceso de cultivo, cuidado y cosecha de las 
